...
async def init():
    global browser, tab
    browser = await launch(headless=False, args=['--disable-infobars', f'--window-size={WINDOW_WIDTH},{WINDOW_HEIGHT}'])
...
async def scrape_page(url, selector):
    ...
    try:
        ...
        logging.error('error occurred while scraping page %s', url, exc_info=True)
